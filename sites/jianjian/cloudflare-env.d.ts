/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 481cf6dd585250ff427fe0f44f9bd98b)
// Runtime types generated with workerd@1.20251210.0 2025-11-20 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface Env {
    KV: KVNamespace;
    NEXT_PUBLIC_API_URL: 'https://admin.xiaoniaoshuo.com';
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'NEXT_PUBLIC_API_URL' | 'NEXT_PUBLIC_SITE_URL'>> {}
}
