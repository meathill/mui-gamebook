/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 56376f2d65d7d84983c2bb2721b88d56)
// Runtime types generated with workerd@1.20251217.0 2025-11-20 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface Env {
    KV: KVNamespace;
    NEXT_PUBLIC_API_URL: 'https://cms.xiaoniaoshuo.com';
    NEXT_PUBLIC_SITE_URL: 'https://xiaoniaoshuo.com';
    NEXT_PUBLIC_SITE_NAME: '小鸟说';
    NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
    WORKER_SELF_REFERENCE: Fetcher /* xiaoniaoshuo */;
    MAIN_APP: Fetcher /* mui-gamebook */;
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, 'NEXT_PUBLIC_API_URL' | 'NEXT_PUBLIC_SITE_URL' | 'NEXT_PUBLIC_SITE_NAME'>
    > {}
}
