/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 5f3b8dc53a36ba8c8aee29a1077f6988)
...
declare namespace Cloudflare {
  interface Env {
    ...
    NEXT_PUBLIC_AWESOME_COMMENT_SITE_ID: string;
  ...
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        ...
        | 'TRUSTED_ORIGINS'
        | 'HEADLESS_MODE'
        | 'NEXT_PUBLIC_AWESOME_COMMENT_SITE_ID'
        | 'NEXT_PUBLIC_GOOGLE_CLIENT_ID'
        | 'NEXT_PUBLIC_ROOT_USER_EMAIL'
