/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 019fdbe366e2777479338c462222fbcc)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_SITE_URL: "https://mui-gamebook.meathill.workers.dev/";
		NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_SECRET" | "BETTER_AUTH_SECRET" | "NEXT_PUBLIC_SITE_URL" | "NEXTJS_ENV">> {}
}
