/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: f365fd26ce11987a1ee8632d7295132a)
// Runtime types generated with workerd@1.20251217.0 2025-11-20 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		ASSETS_PUBLIC_DOMAIN: "https://i.muistory.com";
		COOKIE_DOMAIN: string;
		CRON_SECRET: "mui-gamebook-cron";
		...
		SENDER_EMAIL: "noreply@muistory.com";
		TRUSTED_ORIGINS: string;
		SENDFLARE_KEY: string;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		ASSETS_BUCKET: R2Bucket;
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* mui-gamebook */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ASSETS_PUBLIC_DOMAIN" | "COOKIE_DOMAIN" | "CRON_SECRET" | "HEADLESS_MODE" | "GOOGLE_MODEL" | "GOOGLE_IMAGE_MODEL" | "GOOGLE_TTS_MODEL" | "DEFAULT_TTS_VOICE" | "GOOGLE_VIDEO_MODEL" | "OPENAI_TTS_MODEL" | "OPENAI_VIDEO_MODEL" | "NEXT_PUBLIC_GA_ID" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_SITE_NAME" | "ROOT_USER_EMAIL" | "RPC_PROVIDER_URL" | "SENDER_EMAIL" | "TRUSTED_ORIGINS" | "SENDFLARE_KEY">> {}
}
