    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="rounded-lg border border-amber-200 bg-amber-50 text-amber-900 mb-8 p-6 shadow">
          ...
          <p className="mb-2">
            你好，欢迎来到姆伊故事书。有一天我突然想到，利用 AI
            可以把互动小说/文字冒险游戏的开发门槛降到最低，让更多人能够创作和分享自己的故事。同时，开发得当的话，让作者控制
            AI 而不是受制于 AI，还能保证故事质量和游戏性。于是，我就在 AI 开发工具的帮助下，创造出这个平台。
          </p>
          <p className="mb-2">
          ...
          <p className="mb-4 text-end">—— Meathill</p>
        </div>
        <h2 className="text-4xl font-extrabold text-gray-900 text-center mb-10">游戏库</h2>
        ...
        {games.length === 0 && <div className="text-center text-gray-500 mt-10">暂无已发布的游戏，请稍后再来！</div>}
      </div>
    </div>
  );
}
