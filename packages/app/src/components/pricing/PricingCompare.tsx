        ...
        <table className="w-full min-w-[640px] text-left">
          <thead>
            <tr className="border-b border-stone-200 bg-stone-50">
              ...
              <th
                scope="col"
                className="px-4 py-3 text-center text-sm font-semibold text-stone-700">
                免费
              </th>
              <th
                scope="col"
              ...
              <th
                scope="col"
                className="px-4 py-3 text-center text-sm font-semibold text-orange-700 bg-orange-50/50">
                Pro+
              </th>
            </tr>
          </thead>
            ...
            {groups.map((group) => (
              <Fragment key={group}>
                <tr className="bg-stone-50">
                  <td
                    colSpan={4}
                    className="px-4 py-2 text-xs font-bold uppercase tracking-wide text-stone-500">
                    {group}
                  </td>
                </tr>
                {COMPARE_ROWS.filter((row) => row.group === group).map((row) => (
                  <tr
                    ...
                    <th
                      scope="row"
                      className="px-4 py-3 text-left text-sm font-medium text-stone-800">
                      {row.feature}
                    </th>
